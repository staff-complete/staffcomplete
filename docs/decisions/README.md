...
Most decisions below 0023 describe the platform that [ADR-0023](0023-early-access-landing-until-first-customer.md)
archived. They are dormant, not wrong — read 0023 first to know which still bind.
...
| [0002](0002-frontend-stack.md)                            | Frontend Stack                                                              | partially superseded (0021, 0023) |
...
| [0008](0008-deployment.md)                                | Deployment and Infrastructure                                               | superseded (0023)                 |
...
| [0023](0023-early-access-landing-until-first-customer.md) | Strip the Platform to an Early-Access Landing Page Until the First Customer | accepted                          |
