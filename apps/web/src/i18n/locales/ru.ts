...
const ru = {
  ...
  common: {
    ...
    phases: 'нет этапов | {n} этап | {n} этапа | {n} этапов',
  ...
  auth: {
    ...
    signUp: {
      ...
      subtitle: 'Начните бесплатный 30-дневный пробный период. Карта не требуется.',
  ...
  checklists: {
    list: {
      ...
      deleteConfirmBody:
        'Это навсегда удалит шаблон и все {phases} и {steps} внутри него. Отменить это будет нельзя.',
      deleteConfirmSubmit: 'Удалить шаблон',
    },
    editor: {
      ...
      phasesHeading: 'Этапы',
      parallelHint:
        'Шаги в рамках одного этапа можно выполнять параллельно; этап разблокируется, когда завершены все этапы, от которых он зависит.',
      ...
      deletePhaseConfirmSubmit: 'Удалить этап',
      editPhaseName: 'Изменить название этапа',
      savePhaseName: 'Сохранить название этапа',
      cancelEditPhaseName: 'Отмена',
      savedBadge: 'Сохранено',
      runsInParallelLabel: 'Выполняются параллельно',
      ...
      actionConfigHeading: 'Настройка действия',
      titleLabel: 'Название',
