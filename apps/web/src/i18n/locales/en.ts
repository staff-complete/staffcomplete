const en = {
  ...
  checklists: {
    list: {
      ...
      deleteConfirmBody:
        "This permanently deletes the template and all {phases} and {steps} inside it. This can't be undone.",
      deleteConfirmSubmit: 'Delete template',
    },
    editor: {
      ...
      deletePhaseConfirmSubmit: 'Delete phase',
      editPhaseName: 'Edit phase name',
      savePhaseName: 'Save phase name',
      cancelEditPhaseName: 'Cancel',
      savedBadge: 'Saved',
      runsInParallelLabel: 'Runs in parallel',
      phaseNameLabel: 'Phase name',
      phaseNamePlaceholder: 'Day 1',
      addPhaseSubmit: 'Add phase',
      addPhaseSubmitting: 'Adding…',
      addStepHeading: 'Add a step',
      actionConfigHeading: 'Action configuration',
      titleLabel: 'Title',
      ...
      emailToLabel: 'To',
      emailToPlaceholder: '[employeeEmail], or a fixed address',
      emailSubjectLabel: 'Email subject',
      emailBodyLabel: 'Email body',
      emailBodyPlaceholder: 'Hi [employeeName], welcome to the team!',
      emailBodyHint:
        'Available placeholders: [employeeName], [employeeEmail], [employeeRole], [eventDate]',
      validationEmailConfig: 'Recipient, subject, and body are required',
    },
  ...
  myTasks: {
    ...
    waitingOnEarlierSteps: 'Waiting on earlier steps',
  },
